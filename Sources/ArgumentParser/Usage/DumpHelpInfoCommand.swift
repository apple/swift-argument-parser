...
struct DumpHelpInfoCommand: ParsableCommand {
  static var configuration = CommandConfiguration(
    commandName: "dump-help",
    abstract: "Dump help information.")
  ...
  func generateHelp() -> String {
    return DumpHelpInfoGenerator(commandStack: commandStack).rendered()
  }
