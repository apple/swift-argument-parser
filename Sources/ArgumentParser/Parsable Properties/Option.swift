...
/// `@Option` properties with `Optional` type or a default value are optional
/// for the user of your command-line tool.
///
/// An option can have a default values specified as part of its
