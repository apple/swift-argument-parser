...
complete -c 'base-test' -n '__base-test_should_offer_completions_for_positional "base-test" -eq 3' -fa 'help' -d 'Show subcommand help information. Use --search to find commands and options.'
