function __math_should_offer_completions_for -a expected_commands -a expected_positional_index
    ...
    case 'math'
        ...
        case 'stats'
            ...
            case 'quantiles'
                __math_parse_subcommand -r 3 'file=' 'directory=' 'shell=' 'custom=' 'version' 'h/help'
            end
        case 'help'
...
complete -c 'math' -n '__math_should_offer_completions_for "math stats quantiles" 2' -fka '(__math_custom_completion ---completion stats quantiles -- customArg)'
...
complete -c 'math' -n '__math_should_offer_completions_for "math stats quantiles"' -l custom -rfka '(__math_custom_completion ---completion stats quantiles -- --custom)'
